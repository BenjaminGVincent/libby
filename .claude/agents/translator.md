...
11. **Single unified voice — no board / persona names anywhere.** The patient/caregiver track is *one* voice, not a transcript of a deliberation. **Forbidden phrasing** in `plain_language.md`:
