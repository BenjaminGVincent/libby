...
- [Target validation paths](demo-nsclc-egfr-l858r-post-osi-d3m0-target-validation.pdf?v=f528821d) — diagnostic + biomarker workup that hardens the targetable-feature call
...
- [Patient/caregiver PDF](demo-nsclc-egfr-l858r-post-osi-d3m0-plain-language.pdf?v=d53d6781) — plain-language summary
