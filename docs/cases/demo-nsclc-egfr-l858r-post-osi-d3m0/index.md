...
- [Target validation paths](demo-nsclc-egfr-l858r-post-osi-d3m0-target-validation.pdf?v=52447a53) — diagnostic + biomarker workup that hardens the targetable-feature call
...
- [Patient/caregiver PDF](demo-nsclc-egfr-l858r-post-osi-d3m0-plain-language.pdf?v=bcffcd65) — plain-language summary
