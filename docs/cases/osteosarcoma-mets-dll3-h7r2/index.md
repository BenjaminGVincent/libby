...
- [Target validation paths](osteosarcoma-mets-dll3-h7r2-target-validation.pdf?v=db4959b9) — diagnostic + biomarker workup that hardens the targetable-feature call
...
- [Patient/caregiver PDF](osteosarcoma-mets-dll3-h7r2-plain-language.pdf?v=2b6f096d) — plain-language summary
