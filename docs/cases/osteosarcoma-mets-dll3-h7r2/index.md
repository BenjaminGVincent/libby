...
- [Target validation paths](osteosarcoma-mets-dll3-h7r2-target-validation.pdf?v=e2b3d61f) — diagnostic + biomarker workup that hardens the targetable-feature call
- [Recommendations table](osteosarcoma-mets-dll3-h7r2-recommendations.html?v=42476aa2) — ranked options + pipeline context — self-contained HTML that opens offline
...
- [Patient/caregiver PDF](osteosarcoma-mets-dll3-h7r2-plain-language.pdf?v=ddfdcf3b) — plain-language summary
