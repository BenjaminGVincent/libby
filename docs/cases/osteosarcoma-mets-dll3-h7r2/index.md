...
- [Target validation paths](osteosarcoma-mets-dll3-h7r2-target-validation.pdf?v=db1476b7) — diagnostic + biomarker workup that hardens the targetable-feature call
- [Recommendations table](osteosarcoma-mets-dll3-h7r2-recommendations.html?v=4a369f7e) — ranked options + pipeline context — self-contained HTML that opens offline
...
- [Patient/caregiver PDF](osteosarcoma-mets-dll3-h7r2-plain-language.pdf?v=b0ff8bf5) — plain-language summary
