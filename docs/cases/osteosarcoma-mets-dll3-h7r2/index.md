...
- [Target validation paths](osteosarcoma-mets-dll3-h7r2-target-validation.pdf?v=6d83d173) — diagnostic + biomarker workup that hardens the targetable-feature call
- [Recommendations table](osteosarcoma-mets-dll3-h7r2-recommendations.html?v=370aa9c3) — ranked options + pipeline context — self-contained HTML that opens offline
...
- [Patient/caregiver PDF](osteosarcoma-mets-dll3-h7r2-plain-language.pdf?v=04b3008b) — plain-language summary
