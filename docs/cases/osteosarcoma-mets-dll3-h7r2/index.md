...
- [Target validation paths](osteosarcoma-mets-dll3-h7r2-target-validation.pdf?v=083b4d05) — diagnostic + biomarker workup that hardens the targetable-feature call
...
- [Patient/caregiver PDF](osteosarcoma-mets-dll3-h7r2-plain-language.pdf?v=b3ecc6c7) — plain-language summary
