...
- [Target validation paths (PDF)](osteosarcoma-mets-dll3-h7r2-target-validation.pdf?v=56ee1a76) — diagnostic + biomarker workup that hardens the targetable-feature call
- [Recommendations table (HTML)](osteosarcoma-mets-dll3-h7r2-recommendations.html?v=64ff7efc) — ranked options + pipeline context + per-intervention evidence in detail — self-contained HTML that opens offline
...
- [Access guide (offline HTML)](osteosarcoma-mets-dll3-h7r2-accessibility.html?v=5e4e99f2) — same access-guide content as the in-browser page, packaged as a self-contained HTML that opens offline
...
- [Master manuscripts table (offline HTML)](osteosarcoma-mets-dll3-h7r2-manuscripts.html?v=f05a15ad) — same manuscripts inventory as the in-browser page, packaged as a self-contained HTML that opens offline
- [Patient/caregiver PDF](osteosarcoma-mets-dll3-h7r2-plain-language.pdf?v=3b1e16fd) — plain-language summary
...
- [Recommendations table](osteosarcoma-mets-dll3-h7r2-recommendations.html?v=64ff7efc) — ranked options + pipeline context + per-intervention evidence in detail — self-contained HTML that opens offline
...
- [Access guide (offline)](osteosarcoma-mets-dll3-h7r2-accessibility.html?v=5e4e99f2) — same access-guide content packaged as a self-contained HTML that opens offline
...
- [Master manuscripts table (offline)](osteosarcoma-mets-dll3-h7r2-manuscripts.html?v=f05a15ad) — same manuscripts inventory packaged as a self-contained HTML that opens offline

### PDF

- [Target validation paths](osteosarcoma-mets-dll3-h7r2-target-validation.pdf?v=56ee1a76) — diagnostic + biomarker workup that hardens the targetable-feature call
- [Recommendations table](osteosarcoma-mets-dll3-h7r2-recommendations.pdf?v=f55bac6f) — ranked options + pipeline context + evidence in detail, in a print-friendly PDF
- [Access guide](osteosarcoma-mets-dll3-h7r2-accessibility.pdf?v=b7fab4b1) — trial recruitment contacts + manufacturer medical-info lines, in a print-friendly PDF
- [Master manuscripts table](osteosarcoma-mets-dll3-h7r2-manuscripts.pdf?v=321a19ba) — every paper considered — n, effect, variance, toxicities, in a print-friendly PDF
- [Patient/caregiver PDF](osteosarcoma-mets-dll3-h7r2-plain-language.pdf?v=3b1e16fd) — plain-language summary
