...
- [Target validation paths](osteosarcoma-mets-dll3-h7r2-target-validation.pdf?v=d5fa6867) — diagnostic + biomarker workup that hardens the targetable-feature call
...
- [Patient/caregiver PDF](osteosarcoma-mets-dll3-h7r2-plain-language.pdf?v=f945ca68) — plain-language summary
