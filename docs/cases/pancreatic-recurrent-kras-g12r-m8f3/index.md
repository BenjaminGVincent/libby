...
- [Target validation paths](pancreatic-recurrent-kras-g12r-m8f3-target-validation.pdf?v=203f3dd5) — diagnostic + biomarker workup that hardens the targetable-feature call
- [Recommendations table](pancreatic-recurrent-kras-g12r-m8f3-recommendations.pdf?v=ba7bbcf1) — ranked options + pipeline context + evidence in detail, in a print-friendly PDF
- [Access guide](pancreatic-recurrent-kras-g12r-m8f3-accessibility.pdf?v=5bde1693) — how to access each therapy — trial recruitment contacts + manufacturer medical-info lines, in a print-friendly PDF
...
- [Patient/caregiver PDF](pancreatic-recurrent-kras-g12r-m8f3-plain-language.pdf?v=4813375d) — plain-language summary
