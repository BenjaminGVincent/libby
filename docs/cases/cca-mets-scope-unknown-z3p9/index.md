...
- [Target validation paths (PDF)](cca-mets-scope-unknown-z3p9-target-validation.pdf?v=813d7ab2) — diagnostic + biomarker workup that hardens the targetable-feature call
- [Recommendations table (HTML)](cca-mets-scope-unknown-z3p9-recommendations.html?v=b9fbb9bf) — ranked options + pipeline context + per-intervention evidence in detail — self-contained HTML that opens offline
...
- [Access guide (offline HTML)](cca-mets-scope-unknown-z3p9-accessibility.html?v=d5b357c7) — same access-guide content as the in-browser page, packaged as a self-contained HTML that opens offline
...
- [Master manuscripts table (offline HTML)](cca-mets-scope-unknown-z3p9-manuscripts.html?v=41ae720e) — same manuscripts inventory as the in-browser page, packaged as a self-contained HTML that opens offline
- [Patient/caregiver PDF](cca-mets-scope-unknown-z3p9-plain-language.pdf?v=5f9c480e) — plain-language summary
...
- [Recommendations table](cca-mets-scope-unknown-z3p9-recommendations.html?v=b9fbb9bf) — ranked options + pipeline context + per-intervention evidence in detail — self-contained HTML that opens offline
...
- [Access guide (offline)](cca-mets-scope-unknown-z3p9-accessibility.html?v=d5b357c7) — same access-guide content packaged as a self-contained HTML that opens offline
...
- [Master manuscripts table (offline)](cca-mets-scope-unknown-z3p9-manuscripts.html?v=41ae720e) — same manuscripts inventory packaged as a self-contained HTML that opens offline

### PDF

- [Target validation paths](cca-mets-scope-unknown-z3p9-target-validation.pdf?v=813d7ab2) — diagnostic + biomarker workup that hardens the targetable-feature call
- [Recommendations table](cca-mets-scope-unknown-z3p9-recommendations.pdf?v=9070696f) — ranked options + pipeline context + evidence in detail, in a print-friendly PDF
- [Access guide](cca-mets-scope-unknown-z3p9-accessibility.pdf?v=106d26ba) — trial recruitment contacts + manufacturer medical-info lines, in a print-friendly PDF
- [Master manuscripts table](cca-mets-scope-unknown-z3p9-manuscripts.pdf?v=058da36a) — every paper considered — n, effect, variance, toxicities, in a print-friendly PDF
- [Patient/caregiver PDF](cca-mets-scope-unknown-z3p9-plain-language.pdf?v=5f9c480e) — plain-language summary
